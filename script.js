...
// school = "MyClass"
/* Reassignment failed because you cannot reassign a constant variable */
...
console.log(2 + "3");
console.log(2 + 3);
// The first two concatenate because one operand is a string, so JavaScript converts the other to a string.
